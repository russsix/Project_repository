...
def remove_unrecognized_countries(country_codes):
    ...
    for country, code in country_codes.items():
        ...
        if response.status_code == 200:
            recognized_countries[country] = code
        else:
            print(f"L'API non riconosce il paese {country}, quindi verrà escluso.")

    return recognized_countries
